...
declare -a CHECKS=(
  ...
  "config.js.*CLAW_HOME|src/config.js"
  "db.js.*SQLite|src/db.js"
  "bus.js.*WS|src/bus.js"
  "events.js.*NDJSON|src/events.js"
  "commands.js.*슬래시|src/commands.js"
  "agent.js.*CLI spawn|src/agent.js"
  "orchestrator.js|src/orchestrator.js"
  "telegram.js.*Telegram|src/telegram.js"
  "heartbeat.js|src/heartbeat.js"
  "prompt.js.*프롬프트|src/prompt.js"
  "memory.js.*Persistent|src/memory.js"
