...
| [server_api.md](server_api.md) | `server.ts` 글루 + `src/routes/`/mounted sub-router API 234 handlers including `/` / 233 API endpoints + SSE `/api/events` + 49 public event types + legacy WS fallback boundary | REST, SSE, WebSocket, 라우트 |
