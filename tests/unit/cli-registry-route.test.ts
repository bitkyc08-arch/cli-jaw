...
// Isolate the live-registry Kiro augmentation boundary.
...
test('/api/cli-registry excludes JWC from Jaw chat runtime metadata', async () => {
    const app = express();
    ...
    try {
        ...
        assert.equal('jwc' in body.data, false);
    } finally {
