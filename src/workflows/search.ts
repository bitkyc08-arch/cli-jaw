...
export function buildSearchSteerPrompt(options: SearchWorkflowPromptOptions): string {
    ...
    return [
        ...
        `- Search routing + evidence policy: ${home}/skills/jaw-search/SKILL.md`,
        `- Adaptive-fetch ladder (23 resolvers, TLS, Jina, Camoufox): ${home}/skills/jaw-browser/SKILL.md §Known URL Reader`,
        '',
