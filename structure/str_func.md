...
├── public/                   ← Web UI (Vite 8 + ES Modules, 582 files source/assets, ~103644L; generated `public/dist` and `public/public/dist` excluded)
...
│       ├── ws.ts             ← legacy event dispatch plus scoped snapshot/native request bridge (1474L)
│       ├── features/
...
│       │   ├── activity-history.ts ← owned transcript restoration, queue and recovery (326L)
