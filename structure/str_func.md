...
├── public/                   ← Web UI (Vite 8 + ES Modules, 723 files source/assets, ~115473L; generated `public/dist` and `public/public/dist` excluded)
...
│   └── src/
│       ├── main/index.ts     ← Electron main process — BrowserWindow + tray + jaw server spawn + deep-link + IPC (1300L)
