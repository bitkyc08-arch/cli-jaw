...
- **UI 동결 정책 (2026-07-11)**: vanilla Web UI(`public/js`)와 manager(`public/manager`)는 유지보수 동결 — 회귀/크래시/보안/데이터 손상 버그픽스만 허용, 신규 UI 기능 금지. 신규 UI 작업은 dashboard2 계획(`devlog/_plan/260711_manager_redesign_feature_migration/000_master_plan.md`)을 따른다.
