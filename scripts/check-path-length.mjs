...
// observed failure point would just move the cliff. 200 leaves room for a
// 60-char prefix, which covers `C:\Users\<name>\Documents\Projects\cli-jaw\`.
...
export const MAX_TRACKED_PATH_LENGTH = 200;
