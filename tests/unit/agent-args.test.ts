...
test('AG-017: opencode auto permissions omit removed dangerously-skip-permissions flag', () => {
    const args = buildArgs('opencode', 'opencode-go/kimi-k2.6', 'high', 'hi', '', 'auto');
    assert.ok(!args.includes('--dangerously-skip-permissions'));
    assert.ok(args.includes('--format'));
});

test('AG-018: opencode yolo permissions omit removed dangerously-skip-permissions flag', () => {
...
test('AG-020: opencode resume auto permissions omit removed dangerously-skip-permissions flag', () => {
