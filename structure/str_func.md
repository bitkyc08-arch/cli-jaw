...
│   │   │   ├── claude-sdk-session.ts ← internal persistent query, captured text turns and awaited disposal (337L)
│   │   │   ├── claude-sdk-events.ts ← parent tool/text/reasoning/usage mapping and exact final outcome (256L)
│   │   │   ├── claude-sdk-messages.ts ← bounded UTF8 blocks and streamed/snapshot reconciliation (130L)
