...
├── public/                   ← Web UI (Vite 8 + ES Modules, 593 files source/assets, ~101392L; generated `public/dist` and `public/public/dist` excluded)
│   ├── index.html            ← 뼈대 + header project/git status anchor (691L)
