...
├── bin/
│   ├── cli-jaw.ts            ← 28개 root dynamic import branch + grouped user-facing 서브커맨드 라우팅 + --home flag (340L)
...
│       ├── init.ts           ← 초기화 마법사 + --safe/--dry-run + --help (391L)
...
│       ├── doctor.ts         ← 진단 (다중 체크 + claude-i helper/underlying claude + headless 감지, --json) (840L)
